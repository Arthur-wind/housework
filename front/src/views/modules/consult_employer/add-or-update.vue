<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="咨询时间" prop="consult_time">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.consult_time"
                type="datetime"
                :readonly="ro.consult_time"
                placeholder="咨询时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.consult_time" label="咨询时间" prop="consult_time">
              <el-input v-model="ruleForm.consult_time"
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="咨询问题" prop="question">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.question" label="咨询问题" prop="question">
                    <span v-html="ruleForm.question"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.consult_time = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.title = true;
          ...
          if(o=='question'){
            this.ruleForm.question = obj[o];
	    this.ro.question = true;
            continue;
          }
          if(o=='consult_time'){
            this.ruleForm.consult_time = obj[o];
	    this.ro.consult_time = true;
            continue;
          }
	...
	this.ruleForm.question = this.ruleForm.question.replace(reg,'../../../springbootc90g5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `consult_employer/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.consult_employerCrossAddOrUpdateFlag = false;
						 this.parent.search();
