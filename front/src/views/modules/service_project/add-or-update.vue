<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="项目类型" prop="project_type">
          <el-select :disabled="ro.project_type" v-model="ruleForm.project_type" placeholder="请选择项目类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="项目类型" prop="project_type">
	      <el-input v-model="ruleForm.project_type"
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="详细介绍" prop="description">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.description" label="详细介绍" prop="description">
                    <span v-html="ruleForm.description"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.project_name = true;
          ...
          if(o=='project_type'){
            this.ruleForm.project_type = obj[o];
	    this.ro.project_type = true;
            continue;
          }
          if(o=='price'){
	    ...
	    this.ro.contact_phone = true;
          ...
          if(o=='thumbs_up'){
            this.ruleForm.thumbs_up = obj[o];
	    this.ro.thumbs_up = true;
            continue;
          }
          if(o=='thumbs_down'){
            this.ruleForm.thumbs_down = obj[o];
	    this.ro.thumbs_down = true;
            continue;
          }
	...
	this.ruleForm.description = this.ruleForm.description.replace(reg,'../../../springbootc90g5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `service_project/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.service_projectCrossAddOrUpdateFlag = false;
						 this.parent.search();
