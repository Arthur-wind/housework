        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="留言内容">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"  prop="content_picture"
                   :header-align="contents.tableAlign"
                    width="200"
                    label="留言图片">
                    <template slot-scope="scope">
                      <div v-if="scope.row.content_picture">
                        <img :src="$base.url+scope.row.content_picture.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
		    ...
		    label="回复内容">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"  prop="reply_picture"
                   :header-align="contents.tableAlign"
                    width="200"
                    label="回复图片">
                    <template slot-scope="scope">
                      <div v-if="scope.row.reply_picture">
                        <img :src="$base.url+scope.row.reply_picture.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
