<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="预约编号" prop="appointment_no">
            <el-input v-model="ruleForm.appointment_no"
                placeholder="预约编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.appointment_no" label="预约编号" prop="appointment_no">
              <el-input v-model="ruleForm.appointment_no"
                placeholder="预约编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="申请时间" prop="application_time">
            <el-date-picker
                ...
                type="datetime"
                :readonly="ro.application_time"
                placeholder="申请时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.application_time" label="申请时间" prop="application_time">
              <el-input v-model="ruleForm.application_time"
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="申请备注" prop="application_notes">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.application_notes"
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.application_notes" label="申请备注" prop="application_notes">
                    <span v-html="ruleForm.application_notes"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.application_time = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='appointment_no'){
            this.ruleForm.appointment_no = obj[o];
	    ...
	    this.ro.salary = true;
          ...
          if(o=='application_time'){
            this.ruleForm.application_time = obj[o];
	    this.ro.application_time = true;
            continue;
          }
          if(o=='application_notes'){
            this.ruleForm.application_notes = obj[o];
	    this.ro.application_notes = true;
            continue;
          }
    ...
    info(id) {
      this.$http({
        url: `application_appointment/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.application_notes = this.ruleForm.application_notes.replace(reg,'../../../springbootc90g5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `application_appointment/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.application_appointmentCrossAddOrUpdateFlag = false;
						 this.parent.search();
